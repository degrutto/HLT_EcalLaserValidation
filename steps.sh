...
echo "will run : hltGetConfiguration --offline --globaltag " $GT   "--max-events 999999  --input  "$file "orcoff:"$testMenu 

hltGetConfiguration --offline --globaltag $GT  --max-events 999999  --input $file orcoff:$testMenu > hlt.py
